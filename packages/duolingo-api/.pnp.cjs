...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "packageRegistryData": [
      ...
      ["@now/build-utils", [
        ["npm:2.7.0", {
          "packageLocation": "./.yarn/cache/@now-build-utils-npm-2.7.0-92943d12dc-bea2d4b349.zip/node_modules/@now/build-utils/",
          "packageDependencies": [
            ["@now/build-utils", "npm:2.7.0"]
          ],
          "linkType": "HARD",
